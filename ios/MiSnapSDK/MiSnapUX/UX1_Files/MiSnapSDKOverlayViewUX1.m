...
- (void)setupViewWithParams:(NSDictionary *)params orientation:(UIInterfaceOrientation)orientation
{
        ...
        || (self.docCaptureParams.captureMode == MiSnapCaptureModeHighResManual))
    {
        ...
        self.snapButton.enabled = NO;
        #endif
        [self updateSnapButtonLocationWithOrientation:orientation];
    }
    else
    {
        self.snapButton.hidden = YES;
    ...
    [self setGhostImage:self.docCaptureParams.documentType withOrientation:orientation];
...
- (void)updateSnapButtonLocationWithOrientation:(UIInterfaceOrientation)orientation
{
