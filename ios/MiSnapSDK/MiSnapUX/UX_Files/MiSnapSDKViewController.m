...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    self.statusbarOrientation = self.preferredInterfaceOrientationForPresentation;
...
- (void)viewWillTransitionToSize:(CGSize)size withTransitionCoordinator:(id<UIViewControllerTransitionCoordinator>)coordinator
{
    ...
    {
        self.statusbarOrientation = [self currentOrientation];
        ...
        {
            [self.overlayView updateSnapButtonLocationWithOrientation:self.statusbarOrientation];
               ...
               andResults:(NSDictionary *)results
{
    __weak MiSnapSDKViewController* wself = self;
    dispatch_async(dispatch_get_main_queue(), ^{
        if ([wself.delegate respondsToSelector:@selector(miSnapCapturedOriginalImage:andResults:)])
        {
...
- (void)showMiSnap
{
    ...
    [self.captureView initializeObjectsWithCaptureParameters:self.captureParams orientation:self.statusbarOrientation];
